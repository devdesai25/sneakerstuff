...
export default function () {
  const uniqueId = `u_${exec.vu.idInInstance}_${exec.scenario.iterationInInstance}_${Date.now()}`;
  ...
  const res = http.post('http://127.0.0.1:8000/api/signup', payload, params);
